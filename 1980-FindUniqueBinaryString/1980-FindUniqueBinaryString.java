// Last updated: 3/8/2026, 11:40:11 PM
1class Solution {
...
13    }
14
15    public void answer(String soFar, int iterations, ArrayList<String> rr) {
16        if (iterations == 0) {
17            rr.add(soFar);
18        } else {
19            answer(soFar + "0", iterations - 1, rr);
20            answer(soFar + "1", iterations - 1, rr);
21        }
22        return ;
23    }
24}